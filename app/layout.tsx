...
import { Fraunces, Manrope, IBM_Plex_Mono, IBM_Plex_Sans_Arabic, Readex_Pro } from 'next/font/google';
import './globals.css';
...
// Readex Pro — sans-serif arabe moderne, rigoureux et institutionnel.
// Utilisé pour les grands titres AR + citation CEO.
// IBM Plex Sans Arabic reste pour corps, nav, eyebrows, listes.
...
export default function RootLayout({ children }: { children: React.ReactNode }) {
  return (
    <html className={`${fraunces.variable} ${manrope.variable} ${plexMono.variable} ${plexArabic.variable} ${readex.variable}`}>
