...
export function ASA() {
  ...
  return (
    <section id="asa" className="bg-navy text-paper py-24 lg:py-32 relative" aria-labelledby="asa-title">
      ...
      <div className="max-w-shell mx-auto px-6 lg:px-10 relative">
        <header className="filet mb-12">
          ...
          <h2 id="asa-title" className="font-display font-light text-[2rem] lg:text-[3rem] leading-[1.05] tracking-tight text-paper max-w-3xl mb-6">
            {t('title')}
          </h2>
          <p className="text-paper/70 leading-relaxed text-[1.0625rem] max-w-2xl">
            {t('lead')}
          </p>
        </header>
          ...
          {capabilities.map((c, i) => (
            ...
            >
              ...
              <div className="flex-1">
                <h3 className="font-display text-xl lg:text-[1.5rem] tracking-tight mb-3 text-paper">{c.title}</h3>
